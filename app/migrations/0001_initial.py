# Generated by Django 2.2.4 on 2019-09-01 07:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('knows', models.ManyToManyField(related_name='knows_subjects', to='app.Subject')),
                ('learns', models.ManyToManyField(related_name='learns_subjects', to='app.Subject')),
